...
class Merger_2(Merge_Files):
    ...
    def get_header_arff(self):
        ...
        header_lines=["% 1. Title: Microtasks from Experiment TWO",
                    ...
                    "@ATTRIBUTE answer STRING{NO; THERE IS NOT AN ISSUE, I CANNOT TELL, YES; THERE IS AN ISSUE}",
                    ...
                    "@ATTRIBUTE test3 STRING",
                    "@ATTRIBUTE test4 STRING",
                    "@ATTRIBUTE test5 STRING",
